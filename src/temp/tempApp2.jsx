export default function App() {
  return (
    <div className="min-h-screen inset-0 bg-[url('/old-map.webp')] bg-cover bg-center opacity-10 mix-blend-overlay pointer-events-none text-white font-body flex flex-col">
